...
const Ig: FC<{ url: string }> = ({ url }) => {
	return (
		<div className={"w-[480px] relative"}>
			...
			>
				Create stack and modal screens with minimal boilerplate using your
				filesystem. Feel confident with TypeScript.
			</Text>
			<div className="pt-3">
	...
	return (
		<Margin>
			...
			<div className={"relative"}>
				<div className={"flex items-center justify-center z-10 relative"}>
					...
					>
						...
						>
							<CodepenOutlined
								style={{ fontSize: 30 }}
								className={"text-[#0081f1]"}
							/>
							<span className={"text-[#0081f1] text-[25px] font-semibold"}>
								Develop
							</span>
						</div>
					</div>
				...
				<div
					className={"bg-blue-300 w-[1px] h-[100%] absolute left-1/2 top-0"}
				/>
				...
				<div className="relative grid grid-cols-2 gap-x-40 max-lg-gutters:mt-8 max-lg-gutters:grid-cols-auto-min-1 max-lg-gutters:gap-y-16 max-lg-gutters:pl-10">
					<div className={"relative top-[100px]"}>
						<Ig url={"/img/workflows/img_2.png"} />
					</div>
					<div className={"relative top-[50px]"}>
						<Ig url={"/img/workflows/img_1.png"} />
					</div>
