			...
			<div className={"pb-28 pt-32 flex justify-between"}>
				<div style={{ width: "610px" }}>
					...
					>
						...
						<br />a testing platform with real data
						<br />
					...
					>
						AREX solves regression testing challenges by replicating real online
						traffic to the test environment for automated regression testing.
